...
describe('MoveProductComponent', () => {
  ...
  let mockMoveProductService;
  let mockDataService

  beforeEach(async(() => {

    mockMoveProductService = sinon.createStubInstance(MoveProductService);
    mockMoveProductService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: MoveProductService, useValue: mockMoveProductService },
